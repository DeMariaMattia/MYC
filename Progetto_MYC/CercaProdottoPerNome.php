...
<nav class="header">
  <ul>
    ...
    <li class="alignLI"><a href="Logout.php">Logout</a></li>
      ...
      <body>
        <h2 class="text">Inserire nome del prodotto da cercare</h2>
        <a class ="Collegamento" href="Cerca.php">Cerca il prodotto per codice</a>
        <div class="search_wrap search_wrap_3">
			    <div class="search_box">
            <form action="CercaProdottoPerNome.php" method="post">
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(empty($CodiceProdotto_err)&&$CodiceProdotto!=""){
        $sql="SELECT * FROM prodotto WHERE (NomeProdotto='$CodiceProdotto')";
